...
export default async function Home() {
  ...
  const protocolSteps = [
    {
      num: "01",
      title: "Pilih Misi Lapangan",
      desc: "Eksplorasi aksi lingkungan, edukasi, atau sosial yang relevan dengan lokasimu.",
    },
    {
      num: "02",
      title: "Jalankan & Dokumentasikan",
      desc: "Lakukan aksi nyata, ambil bukti foto ber-geotag, dan catat metrik dampak terukur.",
    },
    {
      num: "03",
      title: "Verifikasi Multi-Pihak",
      desc: "Komite verifikator independen mengaudit bukti aksi secara transparan.",
    },
    {
      num: "04",
      title: "Klaim XP, Poin & Reward",
      desc: "Tingkatkan peringkat portofolio dampak dan tukarkan poin dengan merchandise sponsor.",
    },
  ];
    ...
    <div className="-mx-4 -mt-6 md:-mx-8 md:-mt-8">
      ...
      <section className="grid gap-5 sm:grid-cols-3">
        <div className="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-xs transition-shadow hover:shadow-md">
          ...
          <div className="mt-4">
            <p className="text-3xl font-extrabold tracking-tight text-slate-900 font-mono">
              {impact.verifiedActions.toLocaleString("id-ID")}
            </p>
            <p className="mt-1 text-xs text-slate-500 flex items-center gap-1">
              <span className="text-emerald-600 font-medium">100% tervalidasi</span> oleh tim verifikator
            </p>
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-xs transition-shadow hover:shadow-md">
          ...
          <div className="mt-4">
            <p className="text-3xl font-extrabold tracking-tight text-slate-900 font-mono">
              {impact.contributors.toLocaleString("id-ID")}
            </p>
            <p className="mt-1 text-xs text-slate-500 flex items-center gap-1">
              Relawan terdaftar di berbagai wilayah
            </p>
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-xs transition-shadow hover:shadow-md">
          ...
          <div className="mt-4">
            ...
            <p className="mt-1 text-xs text-slate-500 flex items-center gap-1">
              Sampah daur ulang dialihkan dari TPA
            </p>
          </div>
        </div>
      </section>
            ...
            >
              ...
              <div className="mt-6 pt-4 border-t border-slate-100 flex items-center justify-between">
                <div className="text-xs">
                  ...
                  <span className="text-sky-700 font-semibold font-mono">+{m.point_reward} Poin</span>
                </div>
                <Link
                  href={`/missions/${m.slug}`}
        ...
        <section className="overflow-hidden rounded-2xl border border-sky-100 bg-linear-to-r from-sky-50/80 via-white to-sky-50/50 p-6 shadow-xs">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="md:text-right space-y-1">
              ...
              <p className="text-xl font-extrabold font-mono text-slate-900">
                {campaign.current.toLocaleString("id-ID")}{" "}
                <span className="text-xs font-normal text-slate-500">
                  / {campaign.target_value.toLocaleString("id-ID")} kg
                </span>
              </p>
              <p className="text-[11px] text-slate-500">
                {campaign.participants} Partisipan · {campaign.actions} Aksi Lapangan
              </p>
            </div>
          </div>
          ...
          <div className="mt-5 space-y-2">
            ...
            <div className="flex justify-between text-[11px] text-slate-500 font-mono">
              ...
              <span>{campaign.target_value.toLocaleString("id-ID")} kg</span>
            </div>
          </div>
        </section>
      ) : null}
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-xs">
        <div className="grid gap-6 md:grid-cols-3">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-semibold text-sm text-slate-900">Anti-Manipulasi & Geotag</h4>
              <p className="text-xs text-slate-500 mt-1 leading-relaxed">
                Bukti foto diaudit dengan metadata lokasi, timestamp, dan deteksi anomali untuk mencegah duplikasi aksi.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-semibold text-sm text-slate-900">Verifikasi Multi-Pihak</h4>
              <p className="text-xs text-slate-500 mt-1 leading-relaxed">
                Reviewer manusia mengecek kelayakan bukti secara objektif sebelum XP dan poin dirilis ke pengguna.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-semibold text-sm text-slate-900">Portofolio Siap Audit</h4>
              <p className="text-xs text-slate-500 mt-1 leading-relaxed">
                Riwayat kontribusi dapat diunduh dan dibagikan sebagai bukti nyata dampak sosial untuk kampus atau karier.
              </p>
            </div>
          </div>
        </div>
