    ...
    <div className="space-y-8 animate-enter-tactile">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        >
          ...
          <p className="mt-1 text-[11px] text-slate-500 flex items-center gap-1">
            <span>Perlu tindakan verifikasi</span>
        ...
        >
          ...
          <p className="mt-1 text-[11px] text-slate-500 flex items-center gap-1">
            <span>Deteksi flag kecurangan</span>
            <ArrowRight className="h-3 w-3 text-slate-400" />
          </p>
        </Link>
        ...
        >
          ...
          <p className="mt-1 text-[11px] text-slate-500 flex items-center gap-1">
            <span>Dapat diikuti relawan</span>
            <ArrowRight className="h-3 w-3 text-slate-400" />
          </p>
        </Link>
        ...
        >
          ...
          <p className="mt-1 text-[11px] text-slate-500 flex items-center gap-1">
            <span>Lolos audit verifikator</span>
            <ArrowRight className="h-3 w-3 text-slate-400" />
          </p>
        </Link>
      </div>
      ...
      <div className="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-rim space-y-4">
        <div className="flex items-center justify-between border-b border-slate-100 pb-3">
          <div>
            <h2 className="text-base font-bold tracking-tight text-slate-900">
              Antrian Prioritas Masuk
            </h2>
            <p className="text-xs text-slate-500">
              Submission terbaru yang membutuhkan audit berkas bukti
            </p>
          </div>
          <Link
        ...
        {stats.queuePreview.length === 0 ? (
          <p className="py-6 text-center text-xs text-slate-500">
            Antrian verifikasi saat ini bersih. Tidak ada berkas tertunda.
          </p>
        ) : (
            ...
            {stats.queuePreview.map((r) => (
              ...
              >
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-slate-500">
                    Pengirim: <span className="font-semibold text-slate-700">{r.user_name}</span> · Indikator Risiko:{" "}
                    <span
      ...
      <div className="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-rim space-y-4">
        <div className="flex items-center gap-2 border-b border-slate-100 pb-3">
          ...
          <h2 className="text-base font-bold tracking-tight text-slate-900">
            Jejak Audit Verifikasi Terakhir
          </h2>
        </div>

        {stats.recentActivity.length === 0 ? (
          <p className="py-6 text-center text-xs text-slate-500">
            Belum ada jejak audit verifikasi baru.
          </p>
        ) : (
